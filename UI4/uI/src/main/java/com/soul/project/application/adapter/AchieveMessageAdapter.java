...
import com.soul.project.application.bean.PlaceBean.achievelist;
 ...
 */
public class AchieveMessageAdapter extends BaseAdapter
{
	private List<achievelist> list;
	private LayoutInflater inflater;
	
	public AchieveMessageAdapter(Context context,List<achievelist> list)
	{
		this.list = list;
