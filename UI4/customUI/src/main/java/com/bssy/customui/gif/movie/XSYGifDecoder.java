...
public class XSYGifDecoder extends Thread
{
    ...
    private XSYGifFrame currentFrame = null;
    private int code = 0;
    ...
    private byte[] pixels;
    private XSYGifFrame gifFrame;
    private int frameCount;
    private XSYGifAction action = null;

    private byte[] gifData = null;

    public XSYGifDecoder(byte[] data, XSYGifAction act)
    {
        this.gifData = data;
        this.action = act;
    }

    public XSYGifDecoder(InputStream is, XSYGifAction act)
    {
        this.in = is;
        this.action = act;
    }
    ...
    public XSYGifFrame getCurrentFrame()
    {
        return this.currentFrame;
    }

    public XSYGifFrame getFrame(int n)
    {
        XSYGifFrame frame = this.gifFrame;
        int i = 0;
        while (frame != null)
        {
            if (i == n)
    ...
    private int readStream()
    {
        ...
        if (this.in != null)
        {
            ...
            if (!err())
            {
                ...
                {
                    Log.v("gif","readStreamOK="+this.getImage());
                    Log.v("gif","readStreamOK="+this.next().image);
    ...
    private void readImage()
    {
        try
        {
            ...
            {
                this.gifFrame = new XSYGifFrame(this.image, this.delay);
                this.currentFrame = this.gifFrame;
            }
            else
            {
                ...
                f.nextFrame = new XSYGifFrame(this.image, this.delay);
            }
